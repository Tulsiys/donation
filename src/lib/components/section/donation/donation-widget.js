...
class DonationWidget extends React.Component {
	...
	constructor(props) {
		...
		this.state = {
			...
			latestDontaionText: '',
			donationFrequency: [],
			taxDedutionText: this?.props?.name?.taxDedutionText,
			isldtVisible: false,
			isDonationFrequency: false,
			isTaxText: true,
			amoutOptions: this?.props?.name?.amoutOptions,
			regularFrequencyOptions: this?.props?.name?.regularFrequencyOptions,
			donationFrequencyOptions: this?.props?.name?.donationFrequencyOptions,
			donationTypeOptions: this?.props?.name?.donationTypeOptions,
			donationAmount: 0,
			frequency: 1,
			regularFrequency: 0,
			donationType: 1,
			blockTitle: this?.porps?.name?.blockTitle,
			blockSubTitle: this?.props?.name?.blockSubTitle,
			decimalval: false,
			isDonateBtnEnabled: false,
			pageName: this?.props?.name?.pageName
		}
						...
						<div className="landing-page">
							<div id="HOME" className="sec-banner pos-rel">
								<div className="container pos-rel">
									<div className="c-donation-widget">
										<div className="sec-donation form">
											...
											<div className="question">{this.state.blockSubTitle}</div>
