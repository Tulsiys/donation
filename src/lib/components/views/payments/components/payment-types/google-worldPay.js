...
import { GPAY_RECSGD, GPAY_3DSGD, GPAY_NO3DSGD, DONATION_AMOUNT } from '../../../../common/constant';
...
export default function GoogleWorldPay(props) {
  ...
  function processPayment() {
    const tokenizationSpecification = {
      ...
      parameters: {
        gateway: 'worldpay',
        gatewayMerchantId: (/*props.isRecurring ? GPAY_RECSGD :*/ props.donationAmount.toString() > DONATION_AMOUNT ? GPAY_3DSGD : GPAY_NO3DSGD)
      },
    };
